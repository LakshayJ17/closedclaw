...
/**
 * Checks whether a given file path is likely a text file based on its extension.
 */
...
export class ToolExecutor {
  ...
  /**
   * Initializes the ToolExecutor with the given ActionTracker and AgentConfig.
   */
  constructor(
  ...
  /**
   * Resolves a relative path safely, ensuring it does not escape the workspace directory.
   */
  ...
  /**
   * Checks if a relative path is excluded by the configured exclude patterns.
   */
  ...
  /**
   * Asserts that a relative path is not excluded, throwing an error if it is.
   */
  ...
  /**
   * Retrieves the effective text of a file, taking into account any staging overlays or deletions.
   */
  ...
  /**
   * Reads the content of a file from the file system, logging the action and respecting exclusions and size limits.
   */
  ...
  /**
   * Stages the creation of a new file with the specified content, logging the action.
   */
  ...
  /**
   * Stages an update to an existing file's content, logging the action.
   */
  ...
  /**
   * Stages the deletion of an existing file, logging the action.
   */
  ...
  /**
   * Stages the creation of a new folder, logging the action.
   */
  ...
  /**
   * Lists files within a directory, optionally recursively, respecting exclusion patterns.
   */
  ...
  /**
   * Searches for files matching a glob pattern and optionally containing a specific content query.
   */
  searchFiles(
    rootRel: string,
    globPattern: string,
  ...
  /**
   * Analyzes the codebase to provide a summary of the total number of non-excluded files and directories.
   */
  ...
  /**
   * Queues a shell command for execution, logging the pending action.
   */
  ...
  /**
   * Returns a list of root directories where agent skills might be located.
   */
  skillRoots(): string[] {
    const extra =
  ...
  /**
   * Lists all available skills by scanning the skill root directories for SKILL.md files.
   */
  listSkills(): string {
    const lines: string[] = [];
  ...
  /**
   * Reads and returns the content of a specified skill file if it resides within a valid skill root.
   */
  ...
  /**
   * Applies all actions from the tracker that have been marked as approved, writing changes to the file system and executing shell commands.
   */
  ...
  /**
   * Clears the current staging area, discarding any pending unapplied file changes.
   */
  clearStaging(): void {
    this.overlay.clear();
    this.deleted.clear();
